...
Security fixes are provided for **currently supported release lines** of `switon/log` (`switon/log` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/log/security/advisories/new)
